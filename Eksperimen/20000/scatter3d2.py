...
def main():
    ...
    im = Image.open("D:/fadhlan/f44b13efb3f210b4a0cc5c45e4e84d09/MyProgram/MyProgram/bin/Debug/Hasil/prev/1.1 StreamImage.png")
    ...
    axis.scatter(xv, yv, img, c="skyblue", marker="o",s=5)
    axis.set_xlabel("X")
    axis.set_ylabel("Y")
