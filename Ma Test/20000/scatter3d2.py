...
def main():
    ...
    im = Image.open("E:/0TugasAkhir/Program/thissssssssssssssss/f44b13efb3f210b4a0cc5c45e4e84d09/MyProgram/MyProgram/bin/Debug/Hasil/Jun. 12, 2018 0-26-46/1.2 EncryptedImage.png")
    ...
    axis.scatter(xv, yv, img, c="skyblue", marker="o",s=124)
    axis.set_xlabel("X")
    axis.set_ylabel("Y")
